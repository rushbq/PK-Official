<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Step3.aspx.cs" Inherits="myOrder_Step3" %>
    ...
    <div class="container df-container-margin">
        ...
        <asp:PlaceHolder ID="ph_errMessage" runat="server" Visible="false">
            <div class="alert alert-danger">
                ...
                <p><a class="btn btn-default" href="<%=Application["WebUrl"] %>EO/Step3/<%=Req_DataID %>"><%=this.GetLocalResourceObject("txt_url1").ToString()%></a></p>
            </div>
        </asp:PlaceHolder>
        <!-- Content -->
        ...
        <div id="myBtns" class="btn-group btn-group-justified btn-group-lg" role="group">
            <a href="<%=Application["WebUrl"] %>EO/Step2/<%=Req_DataID %>" class="btn btn-default"><%=this.GetLocalResourceObject("btn_上一步").ToString()%></a>
