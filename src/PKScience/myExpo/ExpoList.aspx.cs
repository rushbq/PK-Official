...
public partial class myProd_ExpoList : System.Web.UI.Page
{
    ...
    private void LookupDataList(int pageIndex)
    {
        ...
        //----- 原始資料:取得所有資料 -----
        var query = _data.GetExpos(search, fn_Language.Web_Lang);
    ...
    public string PageUrl
    {
        get
        {
            return "{0}{1}/Activities".FormatThis(webUrl, Req_Lang);
        }
        set
        {
            this._PageUrl = value;
