...
public class fn_Language
{
    ...
    /// <summary>
    /// 目前語系 - Cookie
    /// 若Cookie不存在，自動帶預設語系 zh-TW
    /// </summary>
    public static string Web_Lang
    {
        get
        {
            return HttpContext.Current.Request.Cookies["PKScience_Lang"] != null ?
              HttpContext.Current.Request.Cookies["PKScience_Lang"].Value.ToString() :
              "zh-TW";
        }
        private set
        {
