<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="UserAgreement.aspx.cs" Inherits="myInfo_Paper" %>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m12 l6">
                            <h2 class="title-header"><%=resPublic.menu_404 %></h2>
                        </div>
                        <div class="col s12 m12 l6">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="Server">
    <script>
        $(function () {
            ...
            //載入Html
            $.ajax({
                url: WebUrl + 'myInfo/html/' + Lang + '/UserAgreement.html?v=0620',
                dataType: "html"
