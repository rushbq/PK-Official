<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Patent.aspx.cs" Inherits="myInfo_Patent" %>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col s12 m12 l6">
                            <h2 class="title-header"><%=resPublic.menu_402 %></h2>
                        </div>
                        <div class="col s12 m12 l6">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="Server">
    <script>
        $(function () {
            ...
            //載入Html
            $.ajax({
                url: WebUrl + 'myInfo/html/' + Lang + '/Patent.html',
                dataType: "html"
