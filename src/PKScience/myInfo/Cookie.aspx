<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Cookie.aspx.cs" Inherits="myInfo_Cookie" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptContent" runat="Server">
    <script>
        $(function () {
            ...
            //載入Html
            $.ajax({
                url: WebUrl + 'myInfo/html/' + Lang + '/Cookie.html?v=0620',
                dataType: "html"
