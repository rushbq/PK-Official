<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Search.aspx.cs" Inherits="myEduMember_Search" %>
        ...
        <div class="col-md-12">
            <div class="page-header">
                <h2>學生期保固名單
                    <small>
                        <a>會員管理</a>&nbsp;
                        <i class="fa fa-chevron-right"></i>&nbsp;<span>學生期保固名單</span>
                    </small>
                </h2>
            </div>
        </div>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="form-inline">
                                <asp:DropDownList ID="ddl_dateType" runat="server" CssClass="form-control">
                                    ...
                                    <asp:ListItem Value="2">保固日期</asp:ListItem>
                                </asp:DropDownList>
                    ...
                    <asp:ListView ID="lvDataList" runat="server" ItemPlaceholderID="ph_Items">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <%#Eval("WarrDate").ToString().ToDateString("yyyy-MM-dd") %>                                    
                                </td>
                            </tr>
                        </ItemTemplate>
                        <EmptyDataTemplate>
