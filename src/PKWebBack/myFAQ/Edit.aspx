<%@ Page Title="常見問題維護" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="FAQ_Edit" ValidateRequest="false" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                ...
                <li><a href="<%=Application["WebUrl"] %>FAQ/Search/">常見問題查詢</a></li>
                <li class="active">常見問題維護</li>
            </ol>
        </div>
    </div>
    <!-- Page Header End -->
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    <asp:TextBox ID="tb_Group_Name" runat="server" CssClass="form-control tip" placeholder="識別名稱" MaxLength="200" ToolTip="字數上限 100 字"></asp:TextBox>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3 col-md-3 col-lg-2">類別</label>
                                <div class="col-sm-9 col-md-9 col-lg-10 form-inline">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfv_ddl_FAQClass" runat="server" ErrorMessage="請選擇「類別」" ControlToValidate="ddl_FAQClass" Display="Dynamic" ValidationGroup="Add" CssClass="styleRed help-block"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3 col-md-3 col-lg-2">對象</label>
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    <div class="showRadioGrp">
                                        <asp:RadioButtonList ID="rbl_Target" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                                            <asp:ListItem Value="0" Selected="True">一般會員</asp:ListItem>
                                            <asp:ListItem Value="1">經銷商</asp:ListItem>
                                        </asp:RadioButtonList>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    ...
                                    <div class="help-block">
                                        (前台FAQ列表顯示的排序,若排序相同,則依照建立日期由新到舊排序)
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                ...
                <div id="result" class="collapse in">
                    <div class="panel-body">
                        <div class="btn-group btn-group-justified btn-group-lg">
                            <asp:Literal ID="lt_FAQSet" runat="server"></asp:Literal>
                        </div>
                    </div>
                </div>
                <!-- Table Content End -->
