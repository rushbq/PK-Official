        ...
        <div class="col-sm-4 col-md-2">
            <div class="metro-nav metro-fix-view">
                ...
                <div class="metro-nav-block nav-deep-thistle">
                    <a href="<%=Application["WebUrl"] %>Prod/Batch/" class="text-center">
                        <i class="fa fa-tasks"></i>
                        <div class="status">批次上架</div>
                    </a>
                </div>--%>
                <div class="metro-nav-block">
                    <div style="margin-top: 4px;">
                        <asp:Button ID="btn_doUpd1" runat="server" Text="排序歸零" CssClass="btn btn-default btn-block" ToolTip="(把所有產品排序改回999)" OnClientClick="return confirm('所有產品排序將改回999')" OnClick="btn_doUpd1_Click" />
                    </div>
                    <div style="margin-top: 4px;">
                        <asp:Button ID="btn_doUpd2" runat="server" Text="新品歸零" CssClass="btn btn-default btn-block" ToolTip="(把所有新品改回一般品)" OnClientClick="return confirm('所有新品將改回一般品')" OnClick="btn_doUpd2_Click" />
                    </div>
                    <div style="margin-top: 4px;">
                        <asp:Button ID="btn_doUpd3" runat="server" Text="推薦歸零" CssClass="btn btn-default btn-block" ToolTip="(把所有推薦品改回一般品)" OnClientClick="return confirm('所有推薦品將改回一般品')" OnClick="btn_doUpd3_Click" />
                    </div>
                </div>
            </div>
                            ...
                            <asp:ListView ID="lvDataList" runat="server" ItemPlaceholderID="ph_Items" OnItemCommand="lvDataList_ItemCommand" OnItemDataBound="lvDataList_ItemDataBound">
                                ...
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <asp:Label ID="lb_IsNew" runat="server"></asp:Label>
                                        ...
                                        <td class="text-center">
                                            <a href="<%=Application["WebUrl"] %>Prod/Edit/<%# Server.UrlEncode(Cryptograph.MD5Encrypt(Eval("Prod_ID").ToString(), Application["DesKey"].ToString()))%>/" class="btn btn-primary">
