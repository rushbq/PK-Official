<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ProdClass.aspx.cs" Inherits="myStat_ProdClass" %>
        ...
        <div class="col-md-12">
            <div class="page-header">
                <h2>瀏覽統計 - 產品類別
                    <small>
                        <a>統計資料</a>&nbsp;
                        <i class="fa fa-chevron-right"></i>&nbsp;<span>瀏覽統計 - 產品類別</span>
                    </small>
                </h2>
            </div>
        </div>
                        ...
                        <ItemTemplate>
                            <tr>
                                <td class="text-center">
                                    <a href="<%=Application["WebUrl"] %>Stat/ProdItem/<%#Eval("Class_ID") %>/?sDate=<%#HttpUtility.UrlEncode(Req_sDate) %>&eDate=<%#HttpUtility.UrlEncode(Req_eDate) %>"><%#Eval("Class_ID") %> - <%#Eval("Class_Name") %></a>
                                </td>
