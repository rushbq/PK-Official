<%@ Page Title="產品影片內容設定" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Edit_Sub.aspx.cs" Inherits="PV_Edit_Sub" %>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    <div class="form-inline">
                                        <div class="input-group date showDate" data-link-field="MainContent_tb_PV_PubDate">
                                        ...
                                        <asp:TextBox ID="tb_PV_PubDate" runat="server" Style="display: none"></asp:TextBox>

                                        <asp:RequiredFieldValidator ID="rfv_tb_PV_PubDate" runat="server" ErrorMessage="請選擇「發佈日期」" ControlToValidate="tb_PV_PubDate" Display="Dynamic" ValidationGroup="Add" CssClass="styleRed help-block"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    <asp:TextBox ID="tb_PV_Title" runat="server" CssClass="form-control tip" placeholder="標題" MaxLength="200" ToolTip="字數上限 100 字"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfv_tb_PV_Title" runat="server" ErrorMessage="請填寫「標題」" ControlToValidate="tb_PV_Title" Display="Dynamic" ValidationGroup="Add" CssClass="styleRed help-block"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3 col-md-3 col-lg-2">小圖 <em>*</em></label>
                                <div class="col-sm-6 col-md-6 col-lg-8">
                                    ...
                                    <div class="help-block">
                                        (上傳功能僅限PC使用，<kbd>建議大小：619*412</kbd>)
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    <asp:RadioButtonList ID="rbl_PV_UriSrc" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow" CssClass="showRadioGrp">
                                    ...
                                    <asp:RequiredFieldValidator ID="rfv_rbl_PV_UriSrc" runat="server" ErrorMessage="請選擇「影片來源」" ControlToValidate="rbl_PV_UriSrc" Display="Dynamic" ValidationGroup="Add" CssClass="styleRed help-block"></asp:RequiredFieldValidator>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3 col-md-3 col-lg-2">影片網址 <em>*</em></label>
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    <asp:TextBox ID="tb_PV_Uri" runat="server" CssClass="form-control tip" placeholder="影片網址" MaxLength="250"></asp:TextBox>
                                    <asp:RegularExpressionValidator ID="rev_tb_PV_Uri" runat="server" ErrorMessage="「影片網址」輸入格式不正確" ValidationExpression="http(s)?://([\w-]+\.)+[\w-]+(/[\w- ./?%&=]*)?" ControlToValidate="tb_PV_Uri" Display="Dynamic" ValidationGroup="Add" CssClass="styleRed help-block"></asp:RegularExpressionValidator>
                                    <asp:RequiredFieldValidator ID="rfv_tb_PV_Uri" runat="server" ErrorMessage="請輸入「影片網址」" ControlToValidate="tb_PV_Uri" Display="Dynamic" ValidationGroup="Add" CssClass="styleRed help-block"></asp:RequiredFieldValidator>
                                </div>
                            </div>
