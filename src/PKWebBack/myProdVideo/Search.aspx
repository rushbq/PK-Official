<%@ Page Title="產品影片查詢" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Search.aspx.cs" Inherits="PV_Search" %>
                ...
                <div id="filter" class="collapse in">
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-sm-2">
                                <label>區塊</label>
                                <asp:DropDownList ID="ddl_ClassType" runat="server" CssClass="form-control">
        ...
        <div class="col-sm-4 col-md-2">
            <div class="metro-nav metro-fix-view">
                <div class="metro-nav-block nav-light-blue">
                    <a href="<%=Application["WebUrl"] %>PV/Edit/" class="text-center">
                    ...
                    <asp:ListView ID="lvDataList" runat="server" ItemPlaceholderID="ph_Items" OnItemCommand="lvDataList_ItemCommand" OnItemDataBound="lvDataList_ItemDataBound">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<%=Application["WebUrl"] %>PV/Edit/<%# Server.UrlEncode(Cryptograph.MD5Encrypt(Eval("Group_ID").ToString(), Application["DesKey"].ToString()))%>/" class="btn btn-primary">
