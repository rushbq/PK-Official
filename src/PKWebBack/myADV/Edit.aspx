<%@ Page Title="廣告維護" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="Adv_Edit" ValidateRequest="false" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                ...
                <li><a href="<%=Application["WebUrl"] %>Adv/Search/">廣告查詢</a></li>
                <li class="active">廣告維護</li>
            </ol>
        </div>
    </div>
    <!-- Page Header End -->
                ...
                <div id="data" class="collapse in">
                    <div class="panel-body">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3 col-md-3 col-lg-2">廣告位置 <em>*</em></label>
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    <div class="showRadioGrp">
                                        <asp:RadioButtonList ID="rbl_Adv_Position" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                                            <asp:ListItem Value="1">橫幅廣告</asp:ListItem>
                                            <asp:ListItem Value="2">四格廣告</asp:ListItem>
                                        </asp:RadioButtonList>
                                    </div>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3 col-md-3 col-lg-2">開啟方式</label>
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    <div class="showRadioGrp">
                                        <asp:RadioButtonList ID="rbl_Adv_Target" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                                            <asp:ListItem Value="_self" Selected="True">本頁轉址</asp:ListItem>
                                            <asp:ListItem Value="_blank">開新視窗</asp:ListItem>
                                        </asp:RadioButtonList>
                                    </div>
                                </div>
                            </div>
                ...
                <div id="result" class="collapse in">
                    <div class="panel-body">
                        <div class="btn-group btn-group-justified btn-group-lg">
                            <asp:Literal ID="lt_LangSet" runat="server"></asp:Literal>
                        </div>
                    </div>
                </div>
                <!-- Table Content End -->
