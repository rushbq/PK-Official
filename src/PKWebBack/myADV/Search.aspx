<%@ Page Title="廣告查詢" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Search.aspx.cs" Inherits="Adv_Search" %>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <label>廣告位置</label>
                                <div class="form-inline">
                                    <asp:DropDownList ID="ddl_AdvPos" runat="server" CssClass="form-control">
        ...
        <div class="col-sm-4 col-md-2">
            <div class="metro-nav metro-fix-view">
                <div class="metro-nav-block nav-light-blue">
                    <a href="<%=Application["WebUrl"] %>Adv/Edit/" class="text-center">
                    ...
                    <asp:ListView ID="lvDataList" runat="server" ItemPlaceholderID="ph_Items" OnItemCommand="lvDataList_ItemCommand" OnItemDataBound="lvDataList_ItemDataBound">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <p><span class="label label-warning"><%#Get_AdvPos(Eval("Adv_Position").ToString()) %></span></p>
                                    <p><%#Eval("Group_Name") %></p>
                                </td>
                                <td class="text-center">
                                ...
                                <td class="text-center">
                                    <a href="<%=Application["WebUrl"] %>Adv/Edit/<%# Server.UrlEncode(Cryptograph.MD5Encrypt(Eval("Group_ID").ToString(), Application["DesKey"].ToString()))%>/" class="btn btn-primary">
...
<asp:Content ID="myScript" ContentPlaceHolderID="ScriptContent" runat="Server">
    ...
    <script>
        $(function () {
            ...
            //滑動至指定ID
            $('html, body').animate({
                scrollTop: $(_thisID).offset().top - 130
            }, 600);
            <%}%>
