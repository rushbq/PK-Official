<%@ Page Title="訊息內容設定" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Edit_Sub.aspx.cs" Inherits="Article_Edit_Sub" ValidateRequest="false" %>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    <div class="form-inline">
                                        <div class="input-group date showDate" data-link-field="MainContent_tb_Article_PubDate">
                                        ...
                                        <asp:TextBox ID="tb_Article_PubDate" runat="server" Style="display: none"></asp:TextBox>

                                        <asp:RequiredFieldValidator ID="rfv_tb_Article_PubDate" runat="server" ErrorMessage="請選擇「公告日期」" ControlToValidate="tb_Article_PubDate" Display="Dynamic" ValidationGroup="Add" CssClass="styleRed help-block"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    <asp:TextBox ID="tb_Article_Title" runat="server" CssClass="form-control tip" placeholder="標題" MaxLength="150" ToolTip="字數上限 70 字"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfv_tb_Article_Title" runat="server" ErrorMessage="請填寫「標題」" ControlToValidate="tb_Article_Title" Display="Dynamic" ValidationGroup="Add" CssClass="styleRed help-block"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-sm-3 col-md-3 col-lg-2">簡述 <em>*</em></label>
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    <asp:TextBox ID="tb_Article_Desc" runat="server" CssClass="form-control tip" placeholder="簡述" MaxLength="500" ToolTip="字數上限 250 字" TextMode="MultiLine" Rows="4"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfv_tb_Article_Desc" runat="server" ErrorMessage="請填寫「簡述」" ControlToValidate="tb_Article_Desc" Display="Dynamic" ValidationGroup="Add" CssClass="styleRed help-block"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-8">
                                        ...
                                        <div class="clearfix"></div>
                                        <div class="help-block">
                                            (上傳功能僅限PC使用，<kbd>建議大小：600*400</kbd>)
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                        ...
                                        <div class="bq-callout orange">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3 text-right">
                                                    ...
                                                    <a href="<%=Application["WebUrl"] %>Article/Edit/DetailBox/<%#Param_parentID %>/<%#Param_thisID %>/<%# Cryptograph.MD5Encrypt(Eval("Block_ID").ToString(),fn_Param.DesKey) %>" class="btn btn-primary tip myBox" title="區塊修改"><i class="fa fa-pencil"></i></a>&nbsp;
