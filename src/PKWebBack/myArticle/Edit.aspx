<%@ Page Title="最新消息" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="Article_Edit" ValidateRequest="false" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                ...
                <li><a href="<%=Application["WebUrl"] %>Article/Search/">最新消息</a></li>
                <li class="active">資料編輯</li>
            </ol>
        </div>
    </div>
    <!-- Page Header End -->
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    ...
                                    <div class="help-block">
                                        (前台新聞列表顯示的排序,若排序相同,則依照上架開始日期由新到舊排序)
                                    </div>
                                </div>
                            </div>
                ...
                <div id="result" class="collapse in">
                    <div class="panel-body">
                        <div class="btn-group btn-group-justified btn-group-lg">
                            <asp:Literal ID="lt_NewsSet" runat="server"></asp:Literal>
                        </div>
                    </div>
                </div>
                <!-- Table Content End -->
