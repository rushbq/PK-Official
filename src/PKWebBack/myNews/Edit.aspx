<%@ Page Title="訊息維護" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="News_Edit" ValidateRequest="false" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                ...
                <li><a href="<%=Application["WebUrl"] %>News/Search/">訊息查詢</a></li>
                <li class="active">訊息維護</li>
            </ol>
        </div>
    </div>
    <!-- Page Header End -->
