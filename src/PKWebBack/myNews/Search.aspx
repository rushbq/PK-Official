<%@ Page Title="訊息查詢" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Search.aspx.cs" Inherits="News_Search" %>
        ...
        <div class="col-sm-4 col-md-2">
            <div class="metro-nav metro-fix-view">
                <div class="metro-nav-block nav-light-blue">
                    <a href="<%=Application["WebUrl"] %>News/Edit/" class="text-center">
                    ...
                    <asp:ListView ID="lvDataList" runat="server" ItemPlaceholderID="ph_Items" OnItemCommand="lvDataList_ItemCommand" OnItemDataBound="lvDataList_ItemDataBound">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<%=Application["WebUrl"] %>News/Edit/<%# Server.UrlEncode(Cryptograph.MD5Encrypt(Eval("Group_ID").ToString(), Application["DesKey"].ToString()))%>/" class="btn btn-primary">
