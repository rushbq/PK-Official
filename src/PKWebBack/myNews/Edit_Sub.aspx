<%@ Page Title="訊息內容設定" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Edit_Sub.aspx.cs" Inherits="News_Edit_Sub" ValidateRequest="false" %>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    <div class="form-inline">
                                        <div class="input-group date showDate" data-link-field="MainContent_tb_News_PubDate">
                                        ...
                                        <asp:TextBox ID="tb_News_PubDate" runat="server" Style="display: none"></asp:TextBox>

                                        <asp:RequiredFieldValidator ID="rfv_tb_News_PubDate" runat="server" ErrorMessage="請選擇「公告日期」" ControlToValidate="tb_News_PubDate" Display="Dynamic" ValidationGroup="Add" CssClass="styleRed help-block"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
