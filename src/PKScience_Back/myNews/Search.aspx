<%@ Page Title="新聞查詢" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Search.aspx.cs" Inherits="News_Search" %>
                    ...
                    <asp:ListView ID="lvDataList" runat="server" ItemPlaceholderID="ph_Items" OnItemCommand="lvDataList_ItemCommand" OnItemDataBound="lvDataList_ItemDataBound">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<%=Application["WebUrl"] %>News/Edit/<%# Server.UrlEncode(Cryptograph.MD5Encrypt(Eval("Group_ID").ToString(), fn_Param.DesKey))%>/" class="btn btn-primary">
