...
public partial class News_Edit_Sub : SecurityCheck
{
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                using (DataTable DT = dbConn.LookupDT(cmd, out ErrMsg))
                {
                    ...
                    else
                    {
                        ...
                        this.lt_NavSubject.Text = groupName;
    ...
    private void LookupData()
    {
        try
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                //[SQL] - 資料查詢
                SBSql.AppendLine(" SELECT Base.News_ID, Base.News_Title, Base.News_Desc, Base.News_Pic");
    ...
    private void Add_Data(List<TempParam> ITempList)
    {
        using (SqlCommand cmd = new SqlCommand())
        {
            ...
            SBSql.AppendLine("  , News_Title, News_Desc, News_Pic");
    ...
    private void Edit_Data(List<TempParam> ITempList)
    {
        using (SqlCommand cmd = new SqlCommand())
        {
            ...
            SBSql.AppendLine("  , News_Desc = @News_Desc, News_Pic = @News_Pic");
    ...
    public string Param_FileFolder
    {
        get
        {
            return this._Param_FileFolder != null
                ...
                : @"{0}News\{1}\".FormatThis(fn_Param.File_DiskUrl, Param_parentID);
        }
        set
        {
    ...
    public string Param_WebFolder
    {
        get
        {
            return this._Param_WebFolder != null
                ...
                : @"{0}News/{1}/".FormatThis(fn_Param.File_WebUrl, Param_parentID);
        }
        set
        {
