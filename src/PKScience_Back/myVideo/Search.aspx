<%@ Page Title="影片查詢" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Search.aspx.cs" Inherits="Video_Search" %>
        ...
        <div class="col-sm-4 col-md-2">
            <div class="metro-nav metro-fix-view">
                <div class="metro-nav-block nav-light-blue">
                    <a href="<%=Application["WebUrl"] %>Video/Edit/" class="text-center">
                    ...
                    <asp:ListView ID="lvDataList" runat="server" ItemPlaceholderID="ph_Items" OnItemCommand="lvDataList_ItemCommand" OnItemDataBound="lvDataList_ItemDataBound">
                            ...
                            <table class="table table-bordered table-advance table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 35%">識別名稱</th>
                                        <th style="width: 15%">上架期間</th>
                                        <th style="width: 15%">首頁顯示期間</th>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td class="text-center">
                                    <%#Eval("ActStartDate").ToString().ToDateString("yyyy-MM-dd HH:mm:ss") %>
                                    <br />
                                    <i class="fa fa-chevron-down"></i>
                                    <br />
                                    <%#Eval("ActEndDate").ToString().ToDateString("yyyy-MM-dd HH:mm:ss") %>
                                </td>
                                <td class="text-center">
                                    <asp:Label ID="lb_Status" runat="server"></asp:Label>
                                </td>
                                <td class="text-center">
                                    <a href="<%=Application["WebUrl"] %>Video/Edit/<%# Server.UrlEncode(Cryptograph.MD5Encrypt(Eval("Group_ID").ToString(), fn_Param.DesKey))%>/" class="btn btn-primary">
