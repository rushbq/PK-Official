...
namespace LogRecord
{
    ...
    public class fn_Log
    {
        ...
        /// <remarks>
        /// ProcType = nvarchar(10)
        /// ProcAction = nvarchar(10)
        /// CreateWho = varchar(10)
        /// </remarks>
            ...
            , string ProcDesc, string CreateWho)
        {
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    SBSql.AppendLine(" Declare @Log_ID AS INT ");
                    //[SQL] - 寫入Log
                    SBSql.AppendLine(" SET @Log_ID = (SELECT ISNULL(MAX(Log_ID), 0) + 1 FROM Log_AuthSetting) ");
                    SBSql.AppendLine(" INSERT INTO Log_AuthSetting( ");
