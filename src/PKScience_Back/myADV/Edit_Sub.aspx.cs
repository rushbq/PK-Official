...
public partial class Adv_Edit_Sub : SecurityCheck
{
    ...
    private void LookupData()
    {
        try
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                //[SQL] - 資料查詢
                SBSql.AppendLine(" SELECT Base.Adv_ID,  Base.Adv_Title, Base.Adv_Pic, Base.Adv_Url");
                ...
                using (DataTable DT = dbConn.LookupDT(cmd, out ErrMsg))
                {
                    ...
                    else
                    {
                        ...
                        this.tb_Adv_Url.Text = DT.Rows[0]["Adv_Url"].ToString();
    ...
    private void Add_Data(List<TempParam> ITempList)
    {
        using (SqlCommand cmd = new SqlCommand())
        {
            ...
            SBSql.AppendLine("  , Adv_Title, Adv_Pic, Adv_Url");
            ...
            cmd.Parameters.AddWithValue("Adv_Url", this.tb_Adv_Url.Text);
    ...
    private void Edit_Data(List<TempParam> ITempList)
    {
        using (SqlCommand cmd = new SqlCommand())
        {
            ...
            SBSql.AppendLine("  , Adv_Pic = @Adv_Pic, Adv_Url = @Adv_Url");
    ...
    public string Param_FileFolder
    {
        get
        {
            return this._Param_FileFolder != null
                ...
                : @"{0}Adv\{1}\".FormatThis(fn_Param.File_DiskUrl, Param_parentID);
        }
        set
        {
    ...
    public string Param_WebFolder
    {
        get
        {
            return this._Param_WebFolder != null
                ...
                : @"{0}Adv/{1}/".FormatThis(fn_Param.File_WebUrl, Param_parentID);
        }
        set
        {
