                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    <asp:TextBox ID="tb_Adv_Url" runat="server" CssClass="form-control tip" placeholder="連結網址" MaxLength="250"></asp:TextBox>
                                    <asp:RegularExpressionValidator ID="rev_tb_Adv_Url" runat="server" ErrorMessage="「連結網址」輸入格式不正確" ValidationExpression="http(s)?://([\w-]+\.)+[\w-]+(/[\w- ./?%&=]*)?" ControlToValidate="tb_Adv_Url" Display="Dynamic" ValidationGroup="Add" CssClass="styleRed help-block"></asp:RegularExpressionValidator>
                                </div>
                            </div>
