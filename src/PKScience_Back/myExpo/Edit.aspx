<%@ Page Title="活動維護" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="Expo_Edit" ValidateRequest="false" %>
    ...
    <div class="row">
        <div class="col-md-12">
            <ol class="breadcrumb">
                ...
                <li><a href="<%=Application["WebUrl"] %>Expo/Search/">活動查詢</a></li>
                <li class="active">活動維護</li>
            </ol>
        </div>
    </div>
    <!-- Page Header End -->
                ...
                <div id="data" class="collapse in">
                    <div class="panel-body">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3 col-md-3 col-lg-2">活動日期 <em>*</em></label>
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    <div class="form-inline">
                                        <div class="input-group date showDateWithoutTime" data-link-field="MainContent_tb_StartDate_Act">
                                        ...
                                        ~
                                        <div class="input-group date showDateWithoutTime" data-link-field="MainContent_tb_EndDate_Act">
                                    ...
                                    <div>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="請選擇「開始日期」" ControlToValidate="tb_StartDate_Act" Display="Dynamic" ValidationGroup="Add" CssClass="styleRed help-block"></asp:RequiredFieldValidator>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="請選擇「結束日期」" ControlToValidate="tb_EndDate_Act" Display="Dynamic" ValidationGroup="Add" CssClass="styleRed help-block"></asp:RequiredFieldValidator>
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-3 col-md-3 col-lg-2" for="MainContent_ddl_Status">首頁顯示 <em>*</em></label>
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    <div class="form-inline">
                                        <div class="showRadioGrp">
                                            <asp:RadioButtonList ID="rbl_onIndex" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                                    ...
                                    <div class="help-block">
                                        (首頁顯示只會有一筆設定)<br />(依照上架日期時間顯示於首頁，若過了上架日期，則首頁整筆不顯示)
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                ...
                <div id="result" class="collapse in">
                    <div class="panel-body">
                        <div class="btn-group btn-group-justified btn-group-lg">
                            <asp:Literal ID="lt_ExpoSet" runat="server"></asp:Literal>
                        </div>
                    </div>
                </div>
                <!-- Table Content End -->
