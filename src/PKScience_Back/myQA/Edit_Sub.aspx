<%@ Page Title="內容設定" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Edit_Sub.aspx.cs" Inherits="FAQ_Edit_Sub" ValidateRequest="false" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="Server">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-md-9 col-lg-10">
                                    <asp:TextBox ID="tb_FAQ_Title" runat="server" CssClass="form-control tip" placeholder="標題" MaxLength="150" ToolTip="字數上限 70 字"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="rfv_tb_FAQ_Title" runat="server" ErrorMessage="請填寫「標題」" ControlToValidate="tb_FAQ_Title" Display="Dynamic" ValidationGroup="Add" CssClass="styleRed help-block"></asp:RequiredFieldValidator>
                                </div>
                            </div>
    ...
    <!-- Form End -->
    <!-- Data Block Start -->
    <asp:PlaceHolder ID="ph_DataBlock" runat="server" Visible="false">
        <!-- Block Add Start -->
        <div class="row">
            <div class="col-sm-9 col-md-10">
                <div class="panel panel-info">
                                        ...
                                        <div class="bq-callout orange">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-3 text-right">
                                                    ...
                                                    <a href="<%=Application["WebUrl"] %>QA/Edit/DetailBox/<%#Param_thisID %>/<%# Cryptograph.MD5Encrypt(Eval("Block_ID").ToString(),fn_Param.DesKey) %>" class="btn btn-primary tip myBox" title="區塊修改"><i class="fa fa-pencil"></i></a>&nbsp;
