<%@ Page Title="Products" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="TagSearch.aspx.cs" Inherits="myTagEvent_TagSearch" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="container df-container-margin">
        <asp:PlaceHolder ID="ph_Banner" runat="server">
                                ...
                                <div class="row">
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="image-container">
                                            <a href="<%=Application["WebUrl"] %>Product/<%#Server.UrlEncode(Eval("ModelNo").ToString()) %>/" title="<%# fn_stringFormat.Set_FilterHtml(Eval("ModelName").ToString()) %>" target="_blank">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        ...
                                        <div class="content">
                                            <p class="title"><a href="<%=Application["WebUrl"] %>Product/<%#Server.UrlEncode(Eval("ModelNo").ToString()) %>/" target="_blank"><%#Eval("ModelNo") %></a></p>
                                            <p class="name"><a href="<%=Application["WebUrl"] %>Product/<%#Server.UrlEncode(Eval("ModelNo").ToString()) %>/" target="_blank"><%#Eval("ModelName") %></a></p>
                                        </div>
                                        <!-- 立即購買 -->
                                        <div class="btn-bord">
                                            <div class="btn-box">
