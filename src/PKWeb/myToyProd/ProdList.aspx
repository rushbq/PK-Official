<%@ Page Title="RobotKits" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ProdList.aspx.cs" Inherits="myToyProd_ProdList" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="container df-container-margin">
        ...
        <div class="page-header">
            <h3><%=Resources.resPublic.title_科學玩具 %>
