<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ArticleList.aspx.cs" Inherits="myNews_ArticleList" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="container df-container-margin">
        <div class="page-header">
            <h3><%=Resources.resPublic.title_最新消息 %>
            </h3>
        </div>
        ...
        <asp:ListView ID="lvDataList" runat="server" ItemPlaceholderID="ph_Items" OnItemDataBound="lvDataList_ItemDataBound">
            ...
            <ItemTemplate>
                <div class="card col-xs-12 col-md-4">
                    <a href="<%=Application["WebUrl"] %>Article/View/<%#Cryptograph.MD5Encrypt(Eval("Article_ID").ToString(), Application["DesKey"].ToString()) %>/">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <%#Eval("Article_Desc").ToString().Replace("\r","<br/>") %>
                            </p>
                        </div>
                        <div class="card-footer"><small class="text-muted"><%#Eval("Article_PubDate").ToString().ToDateString("yyyy/MM/dd") %></small></div>
                    </a>
                </div>
            </ItemTemplate>
            <EmptyDataTemplate>
