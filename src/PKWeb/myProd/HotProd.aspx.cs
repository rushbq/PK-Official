 ...
 * 工具產品-Hot
 */
public partial class myProd_HotProd : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                //** 次標題 **
                this.Page.Title = Resources.resPublic.title_HotProd_Tool;
    ...
    private void LookupDataList(int pageIndex)
    {
        ...
        {
            //[參數宣告] - 設定本頁Url(末端無須加 "/")
            this.ViewState["Page_Url"] = "{0}HotProd/{1}".FormatThis(
                    Application["WebUrl"]
    ...
    protected void btn_Search_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            SBUrl.Append("{0}HotProd/{1}/".FormatThis(
                    Application["WebUrl"]
